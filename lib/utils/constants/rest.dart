...
final String BASE_API_URL = 'https://ar-rasyid.net'; //'https://esiportal.com';
final Duration TIMEOUT_DURATION = Duration(seconds: 10);
...
final String TRANSACTION_API_URL = '/api/transactions';
